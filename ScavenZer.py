...
class SearchPattern():
	...
	def get_params(self):
		...
		parser.add_argument("--country-code", metavar="[COUNTRY CODE]", nargs='+', help="Limit phone search to specific countries. If not used, default is US. 'all' can be used as well. List of available country codes in https://github.com/Offorensics/Scavenzer")
